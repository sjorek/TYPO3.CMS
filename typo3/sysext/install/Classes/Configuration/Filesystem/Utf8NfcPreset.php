...
class Utf8NfcPreset extends AbstractPreset
{
    ...
    protected $configurationValues = array(
        'SYS/UTF8filesystem' => UnicodeNormalizer::NFC
    );

    /**
     * Check utf8 filesystem is supported
     *
     * @return boolean TRUE if utf8 filesystem normalized to NFC is supported
     */
    public function isAvailable()
    {
        if (!$this->hasNormalizionForm(UnicodeNormalizer::NFC)) {
            return false;
        }
        ...
        return (
            ...
            $capabilities['normalization'][UnicodeNormalizer::NFC] === true
        );
    }
}
