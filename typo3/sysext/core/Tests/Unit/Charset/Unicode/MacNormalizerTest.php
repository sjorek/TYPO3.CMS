...
/**
 * Testcase for \TYPO3\CMS\Core\Charset\Unicode\MacNormalizer
 *
 * @author Stephan Jorek <stephan.jorek@gmail.com>
 */
class MacNormalizerTest extends AbstractNormalizerTestCase
{
    /**
     * @var \TYPO3\CMS\Core\Charset\Unicode\MacNormalizer
     */
    protected $subject;
     ...
     * @var string
     */
    protected $implementationClass = MacNormalizer::class;
     ...
     * @test
     * @covers \TYPO3\CMS\Core\Charset\Unicode\MacNormalizer::isNormalized()
     ...
     * @param integer|null $form
     * @test
     * @covers \TYPO3\CMS\Core\Charset\Unicode\MacNormalizer::normalize()
