...
/**
 * Testcase for \TYPO3\CMS\Core\Charset\Unicode\SymfonyNormalizer
 *
 * @author Stephan Jorek <stephan.jorek@gmail.com>
 */
class SymfonyNormalizerTest extends AbstractNormalizerTestCase
{
    /**
     * @var \TYPO3\CMS\Core\Charset\Unicode\SymfonyNormalizer
     */
    protected $subject;
     ...
     * @var string
     */
    protected $implementationClass = SymfonyNormalizer::class;
     ...
     * @test
     * @covers \TYPO3\CMS\Core\Charset\Unicode\SymfonyNormalizer::isNormalized()
     ...
     * @param integer|null $form
     * @test
     * @covers \TYPO3\CMS\Core\Charset\Unicode\SymfonyNormalizer::normalize()
