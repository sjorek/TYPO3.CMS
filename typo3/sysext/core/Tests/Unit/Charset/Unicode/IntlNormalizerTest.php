...
/**
 * Testcase for \TYPO3\CMS\Core\Charset\Unicode\IntlNormalizer
 *
 * @author Stephan Jorek <stephan.jorek@gmail.com>
 */
class IntlNormalizerTest extends AbstractNormalizerTestCase
{
    /**
     * @var \TYPO3\CMS\Core\Charset\Unicode\IntlNormalizer
     */
    protected $subject;
     ...
     * @var string
     */
    protected $implementationClass = IntlNormalizer::class;
     ...
     * @test
     * @covers \TYPO3\CMS\Core\Charset\Unicode\IntlNormalizer::isNormalized()
     ...
     * @param integer|null $form
     * @test
     * @covers \TYPO3\CMS\Core\Charset\Unicode\IntlNormalizer::normalize()
