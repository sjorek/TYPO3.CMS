...
/**
 * Testcase for \TYPO3\CMS\Core\Charset\Unicode\StubNormalizer
 *
 * @author Stephan Jorek <stephan.jorek@gmail.com>
 */
class StubNormalizerTest extends AbstractNormalizerTestCase
{
    /**
     * @var \TYPO3\CMS\Core\Charset\Unicode\StubNormalizer
     */
    protected $subject;
     ...
     * @var string
     */
    protected $implementationClass = StubNormalizer::class;
     ...
     * @test
     * @covers \TYPO3\CMS\Core\Charset\Unicode\StubNormalizer::isNormalized()
     ...
     * @param integer|null $form
     * @test
     * @covers \TYPO3\CMS\Core\Charset\Unicode\StubNormalizer::normalize()
