 ...
 */
class CustomNormalizerTest extends AbstractNormalizerTestCase
{
    /**
     * @var \TYPO3\CMS\Core\Charset\Unicode\CustomNormalizer
     */
    protected $subject;
     ...
     * @var string
     */
    protected $implementationClass = CustomNormalizer::class;
     ...
     * @test
     * @covers \TYPO3\CMS\Core\Charset\Unicode\CustomNormalizer::isNormalized()
     ...
     * @param integer|null $form
     * @test
     * @covers \TYPO3\CMS\Core\Charset\Unicode\CustomNormalizer::normalize()
