...
class UnicodeNormalizationTestUpdater implements \IteratorAggregate {
    ...
    public static function setup($pathToPatchworkPackage) {
        ...
        require __DIR__ .'/UnicodeNormalizationTestWriter.php';
    }
    ...
    public function processLine($lineNumber, $line)
    {
        ...
        if (6 === count($codes)) {
                        ...
                        function($n) use($lineNumber) {
                            ...
                            if ($m === false) {
                                throw new \Exception(sprintf(
                                    'Could not create NFD_MAC in line %s of: %s',
                                    $lineNumber,
                                    $this->source
                                ) . chr(10));
                            }
            ...
            return [str_replace('#      source; NFC; NFD; NFKC; NFKD',
